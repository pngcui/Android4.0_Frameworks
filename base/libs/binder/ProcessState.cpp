...
sp<ProcessState> ProcessState::self()
{
    ...
    if (gProcess == NULL) gProcess = new ProcessState;//line 325
    return gProcess;
}
...
sp<IBinder> ProcessState::getStrongProxyForHandle(int32_t handle)	// handle = 0(mediaService
{
    sp<IBinder> result;
