...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    //Add flag to check powerkey down status. 0:up release 1:press down. yujian@SSCR 111026
    private static int mKeyDown = 0;
    ...
    private UEventObserver mHDMIObserver = new UEventObserver() {
        ...
        public void onUEvent(UEventObserver.UEvent event) {
            ...
            setHdmiPlugged("online".equals(event.get("HDMI_STATE")));//jmq.change hdmi state string
        }
    };
...
*/
	 //modifed for TC4 powerkey timeout. yujian@SSCR 111026
	 if(mKeyDown == 0){
	        mKeyDown = 1;
	        mPowerKeyHandled = handled;
	        if (!handled) {
    ...
    private boolean interceptPowerKeyUp(boolean canceled) {
        if (!mPowerKeyHandled) {
	     ...
	     mKeyDown = 0;//Set flag that powerkey has released. yujian@SSCR 111026		
            return !canceled;
        } else {
            mKeyDown = 0;
...
//	 final String hdmistatename0 = "/sys/devices/virtual/switch/hdmi/state";
// 	 final String hdmistatename1 = "/sys/class/switch/hdmi/state";
//	 final String hdmiueventname= "DEVPATH=/devices/virtual/switch/hdmi";
        //jmq.change the hdmi hpd device file
	 final String hdmistatename0 = "/sys/devices/virtual/misc/HPD/state";
 	 final String hdmistatename1 = "/sys/class/misc/HPD/state";
	 final String hdmiueventname= "DEVPATH=/devices/virtual/misc/HPD";
	 
        // watch for HDMI plug messages if the hdmi switch exists

	if (new File(hdmistatename0).exists()) {
            mHDMIObserver.startObserving(hdmiueventname);
            final String filename = hdmistatename1;
