...
class MountService extends IMountService.Stub
	...
	//ly 20120416 : when ums plug-out,  mount multi-card.	
        StorageVolume storageVolume;
        int length = mVolumes.size();
        for (int i = 0; i < length; i++) {
		 storageVolume = mVolumes.get(i);
	        final String path = storageVolume.getPath();//Environment.getExternalStorageDirectory().getPath();
    ...
    public void setUsbMassStorageEnabled(boolean enable) {
         ...
         */
        String path = storageVolume.getPath();//Environment.getExternalStorageDirectory().getPath();
        String vs = getVolumeState(path);
        String method = "ums";
