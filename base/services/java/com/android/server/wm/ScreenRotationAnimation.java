...
class ScreenRotationAnimation {
    ...
    public ScreenRotationAnimation(Context context, SurfaceSession session,
        ...
        mHwRotation = SystemProperties.getInt("ro.sf.hwrotation", 0);
	 mHwRotation = 0;//jmq.handle ro.sf.hwrotation in service.  
	 if(mHwRotation == 90)
	 {
		 mSnapshotRotation = 3;
	 }else if(mHwRotation == 180)
	 {
	 	mSnapshotRotation = 2;
	 }
	 else if(mHwRotation == 270)
	 {
	 	mSnapshotRotation = 1;
	 }else
	 {
        ...
        if (originalRotation == Surface.ROTATION_90
            ...
            if(mSnapshotRotation == 0 || mSnapshotRotation == 2)
            {
