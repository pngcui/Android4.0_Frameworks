...
public final class RIL extends BaseCommands implements CommandsInterface {
    ...
    public void resetRadio(Message result) {
        ...
        //chy modiry @20120612 for multi reset type  
        RILRequest rr
                = RILRequest.obtain(RIL_REQUEST_RESET_RADIO, null);
        
        if(result != null){
			mResetType = (int)result.what;
			Log.i(LOG_TAG, "reset radio in type "+mResetType);
			
			rr.mp.writeInt(1);
			rr.mp.writeInt(mResetType);
        }
...
*/
        ...
        switch(response) {
            ...
            case RIL_UNSOL_RIL_CONNECTED: {
                ...
                // Initial conditions
                //Feng, commented, removed AT+CFUN=0
