...
#ifdef USE_ALP_AUDIO
    { MEDIA_MIMETYPE_AUDIO_MPEG, "OMX.SEC.MP3.Decoder" },
#endif
...
#if defined(USE_FFMPEG)
    { MEDIA_MIMETYPE_VIDEO_MPEG2, "OMX.SEC.MPEG2.Decoder" },
#endif	
    { MEDIA_MIMETYPE_VIDEO_MPEG2, "OMX.Nvidia.mpeg2v.decode" },
#if defined(USE_FFMPEG)
    { MEDIA_MIMETYPE_VIDEO_VC1, "OMX.SEC.WMV.Decoder"},

    { MEDIA_MIMETYPE_VIDEO_FFMPEG, "FfmpegVideoDecoder"},
    { MEDIA_MIMETYPE_AUDIO_FFMPEG, "FfmpegAudioDecoder"},
#endif	
};
...
#ifdef USE_ALP_AUDIO
    if (!strcmp(componentName, "OMX.SEC.MP3.Decoder")) {
