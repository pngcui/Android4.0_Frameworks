...
/*	
        if (mPlugged) {
	     ...
	     Slog.i(TAG, " plugged=" + mPlugged + " shortSide="+ shortSide + " externalShortSide=" + externalShortSide); //yqf
        }
*/
height=0;
	   ...
	   Slog.i(TAG, " plugged=" + mPlugged + " minHeight="+ minHeight); //yqf
